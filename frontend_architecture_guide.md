...
Проект использует **Next.js** (версия 14.1.0) как основной фреймворк для серверного рендеринга (SSR), статической генерации сайтов (SSG) и создания React-приложений.
