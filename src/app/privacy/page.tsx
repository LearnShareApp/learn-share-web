      ...
      <div className="card">
        <div style={{ padding: "1rem", marginBottom: "1rem" }}>
          ...
          <p>
            ...
            collects, uses, and protects information obtained from users. We
            value your privacy and strive to provide maximum protection for your
            personal data.
          </p>
        </div>
        ...
        <div style={{ padding: "1rem", marginBottom: "1rem" }}>
          ...
          <p>
            ...
            unauthorized access, alteration, disclosure, or destruction. Data is
            stored only for the period necessary to ensure service operation.
          </p>
        </div>
